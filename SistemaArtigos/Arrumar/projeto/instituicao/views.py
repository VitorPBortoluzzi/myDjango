...
class InstituicaoCreateView(LoginRequiredMixin, StaffRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'Instituicao cadastrada com sucesso na plataforma!')
...
class InstituicaoUpdateView(LoginRequiredMixin, StaffRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'Instituicao atualizado com sucesso na plataforma!')
        return reverse(self.success_url) 
...
class InstituicaoDeleteView(LoginRequiredMixin, StaffRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(request, 'Há dependências ligadas à essa Instituicao, permissão negada!')
